<?php /*a:2:{s:57:"D:\Web\www.kongbao.com\app\admin\view\admin\node_add.html";i:1623033751;s:54:"D:\Web\www.kongbao.com\app\admin\view\layout\base.html";i:1624086330;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<body>
  ...
  <div class="layui-fluid">
	<div class="layui-form">
		<form action="<?php echo url('node_add'); ?>" method="post" name="example">
			<table class="layui-table" lay-size="lg" lay-skin="line">
			  ...
			  <tbody>
				<tr>
				  ...
				  <td>
					<div class="layui-input-inline">
					  <input class="layui-input" type="text" name="name" placeholder="节点地址">
				...
				<tr>
				  ...
				  <td>
					<div class="layui-input-inline">
					  <input class="layui-input" type="text" name="sort" value="0" placeholder="0">
					</div> 排序：数值越小位置越前
				  </td>
				</tr>
				<?php if(app('request')->param('pid') == 0): ?>
				<tr>
				  <td width="150" align="right"><strong>图标名称：</strong></td>
				  <td>
					<div class="layui-input-inline">
					  <input class="layui-input" type="text" name="icon" value="spread-left" placeholder="spread-left">
					</div> 默认：spread-left
				  </td>
				</tr>
				<?php endif; ?>
				<tr>
				  ...
				  <td>
					<div class="layui-input-inline">
					  ...
					  <input type="radio" name="show" value="2" title="否" checked>
					</div>
				  </td>
				</tr>
				<tr>
				  ...
				  <td>
					<div class="layui-input-inline">
					  <input name="pid" type="hidden" value="<?php echo htmlentities((app('request')->param('pid') ?: 0)); ?>">
					  <input name="level" type="hidden" value="<?php echo app('request')->param('pid')?2 : 1; ?>">	
