<?php /*a:2:{s:55:"D:\Web\www.tp6.com\app\admin\view\admin\admin_edit.html";i:1618568122;s:50:"D:\Web\www.tp6.com\app\admin\view\layout\base.html";i:1624086330;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<body>
  ...
  <div class="layui-fluid">
	<div class="layui-form">
		<form action="<?php echo url('admin_edit'); ?>" method="post" name="example">
			<table class="layui-table" lay-size="lg" lay-skin="line">
			  ...
			  <tbody>
				<tr>
				  ...
				  <td>
					<div class="layui-input-inline">
					  <input class="layui-input" type="text" name="name" value="<?php echo htmlentities($admin['name']); ?>" placeholder="用户名">
					</div>
				  </td>
				</tr>
				<tr>
				  ...
				  <td>
					<div class="layui-input-inline">
					  <input class="layui-input" type="text" name="real_name" value="<?php echo htmlentities($admin['real_name']); ?>" placeholder="真实名字">
					</div>
				  </td>
				</tr>
				<tr>
				  ...
				  <td>
					<div class="layui-input-inline">
					  <input class="layui-input" type="text" name="qq" value="<?php echo htmlentities($admin['qq']); ?>" placeholder="qq">
					</div>
				  </td>
				</tr>
				<tr>
				...
				<tr>
				  ...
				  <td>
					<?php if(empty($adminRole) || (($adminRole instanceof \think\Collection || $adminRole instanceof \think\Paginator ) && $adminRole->isEmpty())): ?>
					...
					<?php else: foreach($adminRole as $val): ?>
					<div class="akali" style="margin-bottom:10px;">
						<div class="layui-input-inline">
						  <select name="role[]">
							<option value="">请选择</option>
							<?php foreach($role as $value): ?>
							<option value="<?php echo htmlentities($value['id']); ?>" <?php if($value['id'] == $val): ?>selected<?php endif; ?>><?php echo htmlentities($value['name']); ?></option>
							<?php endforeach; ?>
						  </select>
						</div>
						<a href="javascript:;" class="layui-btn layui-btn-sm" onclick="add(this)">
				...
				<tr>
				  ...
				  <td>
					<div class="layui-input-inline">
					  <input type="radio" name="status" value="1" title="正常" <?php echo $admin['status']==1 ? ' checked'  :  ''; ?>>
					  <input type="radio" name="status" value="2" title="禁止" <?php echo $admin['status']==2 ? ' checked'  :  ''; ?>>
					</div>
				  </td>
				</tr>
				<tr>
