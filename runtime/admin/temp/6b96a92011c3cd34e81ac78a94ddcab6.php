<?php /*a:2:{s:51:"D:\Web\www.tp6.com\app\admin\view\tixian\index.html";i:1559783995;s:50:"D:\Web\www.tp6.com\app\admin\view\layout\base.html";i:1624086330;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<body>
	...
	<div class="layui-fluid">
		  ...
		  <div class="layui-card-body layui-col-space5">
			...
			<div class="layui-input-inline">
				<a class="<?php echo $status==2 ? 'layui-btn'  :  'layui-btn layui-btn-primary'; ?> layui-btn-sm" href="<?php echo url('', ['status' => '2']); ?>">提现成功<a>
			</div>
			<div class="layui-input-inline">
				<a class="<?php echo $status==3 ? 'layui-btn'  :  'layui-btn layui-btn-primary'; ?> layui-btn-sm" href="<?php echo url('', ['status' => '3']); ?>">提现失败<a>
			</div>
		...
		table.on('tool(user)', function(obj){
			...
			if(layEvent === 'edit')
			{
				...
				layer.open({
					type: 2,
					title: '失败原因',
					content: '<?php echo url("tixian_edit"); ?>?id=' + data.id + '&status=' + 3,
					shadeClose: true,
					shade: [0.8, '#000000'],
					area: ['600px', '500px'],
				});
